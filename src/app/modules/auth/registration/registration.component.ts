...
export class RegistrationComponent implements OnInit,OnDestroy {
 ...
 stateLabel(state:string){return ({waitlisted:'Klinik kurulumu henüz başlatılmadı. Bu hesapla klinik ekranlarına giriş yapılamaz.',queued:'Kliniğiniz kurulum sırasına alındı.',creating:'Ayrı klinik projeniz oluşturuluyor.',waiting:'Klinik projenizin hazır olması bekleniyor.',schema:'Klinik tablolarınız oluşturuluyor.',functions:'Klinik hizmetleriniz hazırlanıyor.',owner:'Klinik sahibi hesabınız hazırlanıyor.',ready:'Kliniğiniz hazır. Klinik hesabınızı oluşturmak için davet e-postanızı açın.',attention:'Klinik kurulumu tamamlanamadı. Odivon yöneticisinin kurulum kaydını incelemesi gerekiyor.'} as any)[state]||'Başvurunuz işleniyor.';}
}
